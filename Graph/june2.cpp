...
void drawImage(GLuint file, float x, float y, float w, float h, float travalue)
{
	...
	if (loadingcount % 130 == 0) {
		for (int m = 0; m < loadingcount / 130; m++) {
			base = base + "|";
		}
	}
...
void render()
{
	...
	renderbitmap(-450, -150, GLUT_BITMAP_TIMES_ROMAN_24, submitted, 1, 1, 1);
	char shash[] = "SHASHANK R 1RN17CS088";
	renderbitmap(-450, -200, GLUT_BITMAP_TIMES_ROMAN_24, shash, 1, 1, 1);
	char shreyas[] = "SHREYAS B 1RN17CS093";
	renderbitmap(-450, -250, GLUT_BITMAP_TIMES_ROMAN_24, shreyas, 1, 1, 1);
	char teach[] = "UNDER THE GUIDANCE OF:";
	renderbitmap(250, -150, GLUT_BITMAP_TIMES_ROMAN_24, teach, 1, 1, 1);
	char mam[] = "DR. SUDHAMANI M  J";
	renderbitmap(250, -200, GLUT_BITMAP_TIMES_ROMAN_24, mam, 1, 1, 1);
